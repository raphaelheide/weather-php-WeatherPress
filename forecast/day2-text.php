...
if ($data['daily']['weathercode'][2] == '0'){
   ...
   if ($data['daily']['weathercode'][2] == '45'){
		  echo 'In some cases, fog can also act as a natural pesticide, reducing the need for chemical treatments to control pests. Fog can help to maintain soil moisture levels and reduce water loss through evaporation, which can be particularly beneficial for crops with shallow roots. ';
	} else {}
	if ($data['daily']['weathercode'][2] == '48'){
   ...
   if ($data['daily']['weathercode'][2] == '51'){
   ...
   if ($data['daily']['weathercode'][2] == '53'){
   ...
   if ($data['daily']['weathercode'][2] == '55'){
   ...
   if ($data['daily']['weathercode'][2] == '56'){
   ...
   if ($data['daily']['weathercode'][2] == '57'){
   ...
   if ($data['daily']['weathercode'][2] == '61'){
	...
	if ($data['daily']['weathercode'][2] == '63'){
	...
	if ($data['daily']['weathercode'][2] == '65'){
  ...
  if ($data['daily']['weathercode'][2] == '66'){
	...
	if ($data['daily']['weathercode'][2] == '67'){
	...
	if ($data['daily']['weathercode'][2] == '71'){
	...
	if ($data['daily']['weathercode'][2] == '73'){
	...
	if ($data['daily']['weathercode'][2] == '75'){
	...
	if ($data['daily']['weathercode'][2] == '77'){
	...
	if ($data['daily']['weathercode'][2] == '80'){
	...
	if ($data['daily']['weathercode'][2] == '81'){
	...
	if ($data['daily']['weathercode'][2] == '82'){
	...
	if ($data['daily']['weathercode'][2] == '85'){
	...
	if ($data['daily']['weathercode'][2] == '86'){
	...
	if ($data['daily']['weathercode'][2] == '95'){
	echo 'Thunderstorm in any moment. Lightning can fix nitrogen in the soil, which can improve soil fertility. Thunderstorms can cool down the temperature and relieve plants from heat stress.';
	} else {} 
	if ($data['daily']['weathercode'][2] == '96'){
	...
	if ($data['daily']['weathercode'][2] == '99'){
